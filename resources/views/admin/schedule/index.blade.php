                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'Hora_inicio'">{{ trans('admin.schedule.columns.Hora_inicio') }}</th>
                                        <th is='sortable' :column="'Hora_final'">{{ trans('admin.schedule.columns.Hora_final') }}</th>
