                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'nombre'">{{ trans('admin.teacher.columns.nombre') }}</th>
                                        <th is='sortable' :column="'turno'">{{ trans('admin.teacher.columns.turno') }}</th>
                                        <th is='sortable' :column="'telefono'">{{ trans('admin.teacher.columns.telefono') }}</th>
